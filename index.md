...
“For Lovejoy, the process starts when “researchers identify a potential problem,” but the recognition that something is a “problem” demands a pre-existing framework of values and interests within which problems can be recognized. And Pimentel’s “wary outlook” (not to mention Lomborg’s rosy one) presupposes some expectations of what the world ought to look like in the ﬁrst place.” ([Sarewitz, 2004, p. 386](zotero://select/library/items/472F775J)) ([pdf](zotero://open-pdf/library/items/CLJHG3ZD?page=2&annotation=M4LBWMUF))

“This alignment of disciplinary perspective and worldly interests is critically important in understanding environmental controversies, because it shows that stripping out conflicts of interest and ideological commitments to look at “what the science is really telling us” can be a meaningless exercise.” ([Sarewitz, 2004, p. 392](zotero://select/library/items/472F775J)) ([pdf](zotero://open-pdf/library/items/CLJHG3ZD?page=8&annotation=EXCFIPUZ))

“it might be most accurate to look at the scientific debate not as tainted by values and interests, but as an explicit—if arcane—negotiation of the conflict between competing values and interests embodied by competing disciplines.” ([Sarewitz, 2004, p. 392](zotero://select/library/items/472F775J)) ([pdf](zotero://open-pdf/library/items/CLJHG3ZD?page=8&annotation=LSGPPK75))

“To summarize thus far: central to the idea that science can help resolve environmental controversies is the expectation that science can help us understand current conditions under which our decisions are being made, and the potential future consequences of those decisions. This expectation must confront the proliferation of available facts that can be used to build competing pictures of current and future conditions, and the embeddedness of such facts in disciplinary perspectives that carry with them normative implications.” ([Sarewitz, 2004, p. 393](zotero://select/library/items/472F775J)) ([pdf](zotero://open-pdf/library/items/CLJHG3ZD?page=8&annotation=GJTT9SAR))
...
“An early concern in the [ALBERTA LAND-USE FRAMEWORK] case was the structure and composition of this small, influential group of individuals who served on the [Regional Advisory Commity (RAC)]. The apparent conflicts of interests in having an RAC chair that was also employed by big oil did not go unnoticed by local public intellectuals (e.g., Sheila Pratt, “Stelmach’s political judgment lacking in civil service appointment,” Edmonton Journal 20 August 2007, A:18). Moreover, the RAC was invited by the land-use secretariat to consider the impact of three economic development scenarios for the region. These scenarios were narrowly defined in terms of three levels of oil sands production (low, medium, and high), for which the lowest level of production was 2 million barrels/day (approximately status quo) and the highest level of production was 6 million barrels/day.” ([Parkins, 2011, p. 7](zotero://select/library/items/ZW8EKDW3)) ([pdf](zotero://open-pdf/library/items/QVX48GFC?page=7&annotation=EGXXKCHN))
...
([Parkins, 2024, p. 16](zotero://select/library/items/FTGFTPEB))

## What are Collective Action Frames?

([Benford and Snow, 2000, p. 613](zotero://select/library/items/8QS3NV8S))

([Benford and Snow, 2000, p. 614](zotero://select/library/items/8QS3NV8S))
...
4. **Resonance:**
    ...
    1. **Frame Credibility**
        ...
        1. Frame Consistency refers to the congruency between an SMO's beliefs, claims, and actions.
            
        2. Empirical Credibility refers to the apparent fit between the framings and events in the world.
            
        3. Credibility of the Claimsmaker
            
    2. **Relative Salience**
        
        1. Centrality has to do with how essential the values, and ideas associated with movement frames are to the lives of the targets of mobilization.
            
        2. Experiential commensurability is when the framining is consistent with the personal experiences of the target.
            
        3. Narrative Fidelity is how well the frame firts with the existing cultural myths, ethos, or inherent ideology.
...
([Krogman, 1996, p. 13](zotero://select/library/items/DT83TUJG))

## Examples of “Representative Anecdotes

([Krogman, 1996, p. 18](zotero://select/library/items/DT83TUJG))
...
- “Social construction of Clayoquot Sound elevates wilderness / tradition but also erases contemporary use and cultural practice as modern” ([Parkins, 2024, p. 48](zotero://select/library/items/8HNX2DNR)) ([pdf](zotero://open-pdf/library/items/2ZUVVTT4?page=48&annotation=TVUQ4J52))
...
- **Community Forests:** managed locally rather than by state agency with local benefit in mind. This is kind of a “private property” solution where the community owns it instead of the federal government. **Definition:** “A public forest area managed by the community as a working forest for the benefit of the community” ([Parkins, 2024, p. 23](zotero://select/library/items/8HNX2DNR)) ([pdf](zotero://open-pdf/library/items/2ZUVVTT4?page=23))
...
“Various forms of direct public involvement where people, individually or through organized groups, can exchange information, express opinions and articulate interests, and have the potential to influence decisions or the outcome of specific forestry issues.” ([Parkins, 2024, p. 26](zotero://select/library/items/8HNX2DNR)) ([pdf](zotero://open-pdf/library/items/2ZUVVTT4?page=26&annotation=SDNKEVWD)) ...especially the **"potential to influence**" aspect
